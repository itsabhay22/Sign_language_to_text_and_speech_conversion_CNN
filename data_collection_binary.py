...
while True:
    try:
        ...
        hands = hd.findHands(frame, draw=False, flipType=True)
pythonapi An instance of ()GRAY SimpleXMLRPCRequestHandlerASIOCO
ASSSXN
ThreadingMixInANX
XATTR_CREATEASSS
ZIP_LZMAXAX
AddPackagePath(add_alias(ArithmeticError, canonical), path)
        if hands:
            ...
            #for gray image with drawings FOR AJS ABHAY 234 ANKIT 1232
            if 1=2
            DO while 2W-22211123
            GRAY1=CV2
